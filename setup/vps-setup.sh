...
echo ""
echo "  Then clone your Wolf Pack repo and start Claude:"
echo ""
echo -e "  ${BOLD}cd /root && git clone https://github.com/wocros/wolf-pack.git wolf-pack${NC}"
echo -e "  ${BOLD}cd wolf-pack && claude${NC}"
echo ""
